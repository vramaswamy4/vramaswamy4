...
| **APElevate** | AP-exam tutoring marketplace I built in high school (2022) and rebuilt in 2026: Django 5.2, a database-enforced token ledger, server-verified PayPal payments, 210 tests, a new interface, and a Terraform-managed Cloud Run deployment with keyless CD. | [repo](https://github.com/vramaswamy4/apelevate) · [live demo](https://apelevate-1065774348021.us-west1.run.app) · [write-up](https://vramaswamy4.github.io/projects/apelevate/) |
...
Docker, Kubernetes, Terraform, Linux, GitHub Actions, Prometheus, Grafana, OpenTelemetry, Jaeger, Render, Cloudflare Workers, AWS (S3, CloudFront, SES, SNS), Google Cloud Run, Sentry, Tilt
