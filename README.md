...
| **APElevate** | AP-exam tutoring marketplace I built in high school (2022) and rebuilt in 2026: Django 5.2, a database-enforced token ledger, server-verified PayPal payments, 217 tests, an LLM study planner on an open-weights model with a 24-case eval suite, and a Terraform-managed Cloud Run deployment with keyless CI/CD and weekly drift detection. | [repo](https://github.com/vramaswamy4/apelevate) · [live demo](https://apelevate-1065774348021.us-west1.run.app) · [write-up](https://vramaswamy4.github.io/projects/apelevate/) |
...
Flask, Django, SQLAlchemy, PostgreSQL, MySQL, MongoDB, Redis, Kafka, RabbitMQ, gRPC, Protocol Buffers, REST APIs, WebSockets, Spark, Cassandra, HDFS, BigQuery
...
Docker, Kubernetes, Terraform, Linux, GitHub Actions, Prometheus, Grafana, OpenTelemetry, Jaeger, Render, Cloudflare Workers, AWS (S3, CloudFront, SES, SNS), Google Cloud (Cloud Run, Cloud Storage, Secret Manager, Workload Identity Federation), Sentry, Tilt
...
React, Next.js, Vite, Astro, htmx, HTML, CSS, Capacitor (iOS and Android), React Native, Figma
...
LLM application design, LLM evaluation, structured outputs (JSON schema), open-weights models (gpt-oss, Qwen), OpenAI-compatible APIs, Groq
